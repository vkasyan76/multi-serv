...
import { MapPin, Clock, Monitor, MapPinOff, Star, CheckCircle } from "lucide-react";
  ...
  return (
        ...
        <div className="flex gap-4 mb-4">
          ...
          <div className="flex-shrink-0">
              ...
              <div className="w-24 h-24 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center shadow-sm">
                {(tenant.image?.url || tenant.user?.clerkImageUrl) ? (
                  <img
                    src={(tenant.image?.url || tenant.user?.clerkImageUrl) ?? undefined}
                    alt={tenant.name}
                    className="w-full h-full object-cover"
                  />
                ) : (
                  <div className="bg-blue-100 text-blue-600 font-semibold text-2xl flex items-center justify-center w-full h-full">
         ...
         <div className="mb-3">
           <div className="flex items-center gap-1">
             ...
             <span className="text-sm text-gray-500 ml-1">
               ...
               }).format(reviewRating)} ({reviewCount} reviews)
             </span>
           </div>
         </div>
