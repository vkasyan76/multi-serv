...
export const TagsFilter = ({ value, onChange }: TagsFilterProps) => {
  ...
  const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } =
    useInfiniteQuery(
      // we need to have type cursor in our procedure to use infiniteQueryOptions
  ...
  // if the tag is in the list, we remove it from the list, otherwise add it to the list: this is the array of tags that are currently selected/checked
