...
type OrderDisputedTenantTemplateProps = {
  tenantName?: string;
  customerName?: string;
  orderId: string;
  dashboardUrl: string;
...
function OrderDisputedTenantEmail(props: OrderDisputedTenantTemplateProps) {
  ...
  return (
    <Html>
      <Head />
      <Preview>Order disputed by {customerName}.</Preview>
...
export async function renderOrderDisputedTenantTemplate(
  ...
  const subject = customerName
    ? `Order disputed by ${customerName}`
    : "Order disputed";
  const html = await render(
    <OrderDisputedTenantEmail
