...
type OrderCompletedCustomerTemplateProps = {
  customerName?: string;
  tenantName?: string;
  tenantSlug?: string;
  orderId: string;
...
function OrderCompletedCustomerEmail(
  props: OrderCompletedCustomerTemplateProps,
) {
...
export async function renderOrderCompletedCustomerTemplate(
